...
# Bot Admins
ADMINS = environ.get('ADMINS', '6169288210')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002210866120').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002210866120')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002164397675')
